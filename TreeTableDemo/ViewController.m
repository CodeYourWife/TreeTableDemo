...
- (void)viewDidLoad {
    ...
    Node *province5 = [[Node alloc] initWithParentId:10 nodeId:12 name:@"德州" depth:1 expand:YES];
    Node *city7 = [[Node alloc] initWithParentId:12 nodeId:13 name:@"休斯顿" depth:2 expand:NO];
    Node *province6 = [[Node alloc] initWithParentId:10 nodeId:14 name:@"加州" depth:1 expand:YES];
    ...
    TreeTableView* table = [[TreeTableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain data:data];
